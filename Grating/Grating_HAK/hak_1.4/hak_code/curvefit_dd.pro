FUNCTION CURVEFIT_dd,X,Y,W,A,SIGMAA, Function_Name = Function_Name
;+
; FUNCTION CURVEFIT_dd,X,Y,W,A,SIGMAA, Function_Name = Function_Name
;
; NAME:
...
;       6/26/95 - dd Modified to break out of REPEAT loop if chisqr
;                    not reduced.
;                    Limit is 11 iterations - typically one is enough
;                    and 4 or 5 are occasionally used.
;    ------------------------------------------------------------
;-
...
;
	...
	REPEAT BEGIN
		...
		ENDREP UNTIL CHISQR LE CHISQ1 or it_enough GT 10
;;              print, 'curvefit_dd: it_enough = ',it_enough
;
