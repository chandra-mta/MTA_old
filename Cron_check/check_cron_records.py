...
#
import mta_common_functions_short as mcf #---- contains other functions commonly used in MTA scripts
#
...
cpu_usr_list = ['colossus-v_mta', 'r2d2-v_mta', 'r2d2-v_cus', 'c3po-v_mta', 'c3po-v_cus',\
                'han-v_mta', 'hav-v_cus', 'luke-v_mta', 'luke-v_cus']
#
...
def file_length(filename):
    ...
    """
    data = mcf.read_data_file(filename)
...
def check_for_error(ifile, start=0):
    ...
    Input:  ifile   --- cron job output file name
            start   --- the last line of the last record. if this is not givne, 
