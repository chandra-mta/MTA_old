...
#
    ...
    day_list = []
    for year in range(1999, 2019):             #---- CHANGE CHANGE CHAGE!!!!! 
        lyear = year
        for mon in range(1, 13):
            if year == 1999 and mon < 9:
                continue
            if year == 2018 and mon > 6:
                continue
...
#
        [week_p, short_p, long_p, atime] = process_day_data(msid, dtime, data, glim, step=0)
#
